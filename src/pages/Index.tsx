...
import { darkPalettes, lightPalettes, pastelPalettes, vintagePalettes, retroPalettes, neonPalettes, goldPalettes, coldPalettes, fallPalettes, winterPalettes, springPalettes, happyPalettes, naturePalettes, earthPalettes, spacePalettes, type Palette } from "@/data/palettes";
...
const Index = () => {
  ...
  const allPalettes = [...darkPalettes, ...lightPalettes, ...pastelPalettes, ...vintagePalettes, ...retroPalettes, ...neonPalettes, ...goldPalettes, ...coldPalettes, ...fallPalettes, ...winterPalettes, ...springPalettes, ...happyPalettes, ...naturePalettes, ...earthPalettes, ...spacePalettes];
